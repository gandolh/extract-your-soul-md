...
purpose. This is the empirical backbone of [dual-use signal](dual-use-signal.md) and the reason
the design [Big Five](../frameworks/big-five.md) is *borrowed* (for its linguistic
...
open question — tracked in [style-card artifact](style-card-artifact.md).

## Sources

[Koutsoumpis 2023](../sources/koutsoumpis-2023.md), [Yarkoni 2010](../sources/yarkoni-2010.md).
