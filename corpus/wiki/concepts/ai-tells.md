...
- **Wikipedia: Signs of AI Writing** ([Wikipedia Signs Of AI Writing](../sources/wikipedia-signs-of-ai-writing.md))
...
- **The Last Fingerprint** ([Last Fingerprint Emdash 2026](../sources/last-fingerprint-emdash-2026.md)) — the
  em dash is markdown leaking into prose; it persists *even under explicit
  suppression*, so it's a robust tell, not a preference.
- **avoid-ai-writing skill** ([avoid-ai-writing skill](../sources/avoid-ai-writing-skill.md)) — 50 named
...
- **Statistical tell**: AI text is systematically *less variable* (lower
  ...
  ([Imitate Style 2025](../sources/imitate-style-2025.md)) — a tell no word-list captures.
...
[Wikipedia Signs Of AI Writing](../sources/wikipedia-signs-of-ai-writing.md),
[Last Fingerprint Emdash 2026](../sources/last-fingerprint-emdash-2026.md),
[avoid-ai-writing skill](../sources/avoid-ai-writing-skill.md), [Imitate Style 2025](../sources/imitate-style-2025.md).
Related: [style-card artifact](style-card-artifact.md), [LLM style-imitation gap](llm-style-imitation-gap.md).
