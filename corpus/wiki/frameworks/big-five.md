...
actually keys on (see [LIWC](liwc.md)):
...
See [self-report vs observer gap](../concepts/self-report-vs-observer-gap.md) and
[dual-use signal](../concepts/dual-use-signal.md).

## Sources

[Koutsoumpis 2023](../sources/koutsoumpis-2023.md), [Yarkoni 2010](../sources/yarkoni-2010.md),
and the Big Five cluster in [references](../sources-raw/references.md).
