...
- Pronoun ratios, article density, and preposition use map onto the
  [Big Five](big-five.md) correlates.
...
(see [LLM style-imitation gap](../concepts/llm-style-imitation-gap.md)), which is why naming them
explicitly in `my-soul.md` matters.

## Sources

LIWC / Pennebaker cluster in [references](../sources-raw/references.md);
[Yarkoni 2010](../sources/yarkoni-2010.md).
